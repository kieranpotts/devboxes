...
Any upgrade of any major component of a box's software stack — for example, upgrading to a newer LTS release of Ubuntu or Node, but excluding the upgrade of development tools — is marked by a **major version bump** for the box.
